* first i created github token which helped me to extract data from github API . I used iibrary requests to scrap users.csv and repositeries.csv.it took 15 minutes to scrap data
